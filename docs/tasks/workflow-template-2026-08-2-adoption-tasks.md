...
- Strengthen formal staged checks so every command rejects non-evidence
  worktree/index divergence before and after execution.
...
- Run selective validation, applicable checks, strict active/all audit, workflow
  runtime public-CLI integration checks, and staged workflow CI.
