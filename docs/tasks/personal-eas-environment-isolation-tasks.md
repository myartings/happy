# Task: `personal-eas-environment-isolation`
...
- Deleting or changing account-wide production variables.
- Changing official Happy profiles.
- TestFlight submission or public App Store release.
