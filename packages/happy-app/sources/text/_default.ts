...
export const en = {
    ...
    codexFirst: {
        ...
        newSessionComposerPlaceholder: 'What would you like to work on?',
        homeReadyTitle: 'What do you want to build?',
        homeReadyDescription: 'Start something new or continue a recent project.',
        homeNoSessionsTitle: 'Start your first session',
        homeNoSessionsDescription: 'Choose a connected machine and project, then tell the agent what to do.',
        homeNoMachinesTitle: 'Connect a machine',
        homeNoMachinesDescription: 'Run Happy in a terminal, then paste its connection URL here.',
        homeOfflineTitle: 'Your machines are offline',
        homeOfflineDescription: 'Bring one online to start or continue work.',
        homeReconnectingTitle: 'Reconnecting…',
        homeReconnectingDescription: 'Restoring your Happy connection.',
        homeConnectionErrorTitle: 'Couldn’t connect',
        homeConnectionErrorDescription: 'Retry session sync or inspect your machines.',
        homeArchivedTitle: 'No active sessions',
        homeArchivedDescription: 'Start a new session or reopen your archive.',
        recentProjects: 'Recent projects',
        troubleshoot: 'Troubleshoot',
        machinesAndAgents: 'Machines & agents',
        commandNewSessionSubtitle: 'Start a new chat session',
        commandSessionsSubtitle: 'Browse your chat history',
        commandSettingsSubtitle: 'Configure your preferences',
        commandSignOutSubtitle: 'Sign out of your account',
        commandDeveloperSubtitle: 'Access developer tools',
        commandNavigationCategory: 'Navigation',
        commandSystemCategory: 'System',
        commandDeveloperCategory: 'Developer',
        ...
        openSidebarTools: 'Open sidebar tools',
        collapseSideChat: 'Collapse workspace panel',
        openSideChat: 'Open side chat',
        sidebarTools: 'Sidebar tools',
        decisionDisconnected: 'Reconnect to respond.',
        decisionExpired: 'This request is no longer available.',
        decisionSubmitting: 'Sending response…',
        settingsIdentity: 'Codex-first · customized by Happy',
        settingsAboutFooter: 'Happy Codex is a customized Codex client by Happy, with Happy\'s cross-device sessions, multi-agent collaboration, and end-to-end encryption fully preserved.',
    },
    ...
    toolGroup: {
        ...
        read: 'Read',
        searched: 'Searched',
        searchedTimes: ({ count }: { count: number }) => count === 1 ? 'Searched 1 time' : `Searched ${count} times`,
        fetched: 'Fetched',
        ranTask: 'Ran task',
    ...
    githubIssues: {
        ...
        openGithubVerification: 'Open GitHub verification',
        chooseRepositories: 'Choose repositories on GitHub',
        ...
        updatedDays: ({ count }: { count: number }) => `updated ${count}d ago`,
        issueAccessibility: ({ number, title }: { number: number; title: string }) => `Issue #${number}: ${title}`,
        disabledShort: 'GitHub Issues is disabled.',
        workOnIssue: 'Work on this issue',
        continueSession: 'Continue Session',
        restoreSession: 'Restore Session',
        repairSession: 'Repair Session',
        checkingSession: 'Checking Session…',
        bindingSession: 'Binding Session…',
        openCachedSession: 'Open cached Session · Offline',
        bindingConflict: 'Resolve Session conflict',
        bindingOffline: 'Session unavailable · Offline',
        bindingRetry: 'The canonical Session authority is unavailable. Your draft is preserved; reconnect and retry.',
        bindingConflictHelp: 'The canonical Session changed. Refresh the Issue and retry.',
        bindingUnavailable: 'The canonical Issue session cannot be confirmed right now. Reconnect and try again.',
        bindingRepairRequired: 'This Issue binding needs repair before work can continue.',
        bindingAccountChanged: ({ issue }: { issue: string }) => `${issue}: This Issue binding belongs to another account. Reopen the Issue and retry.`,
        bindingAccountValidationUnavailable: ({ issue }: { issue: string }) => `${issue}: The Issue binding account could not be verified. Your draft is preserved; reconnect and retry.`,
        bindingStartFailed: ({ issue }: { issue: string }) => `${issue}: The Happy Session could not be started. Your draft is preserved; check the selected machine and retry.`,
        bindingInvalidReplacementRevision: ({ issue }: { issue: string }) => `${issue}: The replacement revision is invalid. Refresh the Issue and retry.`,
        bindingConfirmationUnavailable: ({ issue }: { issue: string }) => `${issue}: Canonical Session confirmation is unavailable. Your draft is preserved; reconnect and retry.`,
        bindingEstablishFailed: ({ issue }: { issue: string }) => `${issue}: The canonical Session could not be established. Refresh the Issue and retry.`,
        bindingStartRepairRequired: ({ issue }: { issue: string }) => `${issue}: The canonical Session binding requires repair. Your draft is preserved; reopen the Issue and retry.`,
        bindingFirstDispatchFailed: ({ issue }: { issue: string }) => `${issue}: The canonical Session was created, but the first task could not be queued. Your draft is preserved; reopen the Issue and retry.`,
        bindingRestoreFailed: ({ issue }: { issue: string }) => `${issue}: The canonical Session could not be restored. Open Session Info to repair or retry.`,
        bindingRecoveryUnavailable: ({ issue }: { issue: string }) => `${issue}: Canonical Session recovery is unavailable. The Session was kept reachable; refresh the Issue and retry.`,
        replaceBindingTitle: 'Replace canonical Session?',
        replaceBindingMessage: ({ issue, oldSession, newSession }: { issue: string; oldSession: string; newSession: string }) => `${issue}\nFormer Session: ${oldSession}\nReplacement Session: ${newSession}`,
        replaceBinding: 'Replace Session',
        replaceCanonicalSession: 'Replace canonical Session…',
        adoptBindingTitle: 'Make this the canonical Session?',
        adoptBindingMessage: ({ issue, session, hasDraft }: { issue: string; session: string; hasDraft: boolean }) => `${issue}\nSession: ${session}\nThis Session will become the Issue's sole Happy continuation point.${hasDraft ? '\nIts existing draft will be preserved and the Issue task appended for review.' : ''}`,
        adoptBinding: 'Make canonical',
        missingSession: 'missing Session',
        currentSession: 'Current',
        replaced: 'Replaced',
        issueUpdatedSinceLoaded: 'Issue updated — review context',
        refreshAgentContext: 'Refresh Agent context',
        cachedIssueContext: 'Cached Issue context',
        staleIssueContext: 'Stale Issue context',
        identityConflict: 'Issue identity conflict · Repair required',
        ...
        updateFailed: 'Could not update issue',
        deleteFailed: 'Could not delete issue',
        workOnIssueNumber: ({ number }: { number: number }) => `Work on issue #${number}`,
        addCurrentSession: 'Add to current session',
        startNewSession: 'Start a new session',
        keepsDraft: 'Keeps existing draft',
        addDraftTitle: 'Add to existing draft?',
        addDraftMessage: 'The issue instructions will be appended to the current session draft.',
        ...
        description: 'Description',
        descriptionPlaceholder: 'Markdown…',
        creating: 'Creating…',
        create: 'Create',
        keepDraftTitle: 'Keep this draft?',
        keepDraftMessage: 'Your title and description can stay on this device for later.',
        keepDraft: 'Keep draft',
        discard: 'Discard',
        createFailed: 'Unable to create issue',
        issueCreated: 'Issue created',
        workOnIt: 'Work on it',
        done: 'Done',
        connectedAs: ({ login }: { login: string }) => `Connected as @${login}`,
        credentialStored: 'Credential stored securely on this device.',
        removeDevice: 'Remove from this device',
        removeDeviceTitle: 'Remove GitHub Issues from this device?',
        removeDeviceMessage: 'Your GitHub App repository selection will not change.',
        remove: 'Remove',
        connectionSettings: 'GitHub Issues connection',
        connectionSettingsDescription: 'Connect, remove this device, or manage repository access',
        featureDescription: 'Manage selected repositories with a device-local GitHub connection',
        supportedPlatforms: 'Available in Happy desktop and mobile',
    },
