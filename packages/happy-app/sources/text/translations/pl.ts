...
export const pl: TranslationStructure = {
    ...
    settingsFeatures: {
        ...
        showSessionModel: 'Pokaż model sesji',
        showSessionModelSubtitle: 'Pokazuj ikonę i nazwę dostawcy AI oraz nazwę i wersję modelu',
    ...
    session: {
        ...
        worktreeForkAction: 'Fork in isolated Worktree…',
        worktreeForkTitle: 'Fork in an isolated Worktree',
        worktreeForkDirtySubtitle: 'Choose whether the new Worktree should inherit the current uncommitted changes.',
        worktreeForkCleanSubtitle: 'Create an independent working directory from the current HEAD.',
        worktreeForkBase: 'Base',
        worktreeForkStaged: 'Staged changes',
        worktreeForkUnstaged: 'Unstaged changes',
        worktreeForkUntracked: 'Untracked files',
        worktreeForkIgnoredNotice: 'Ignored files are not copied. The source working directory remains unchanged.',
        worktreeForkIncludeChanges: 'Include current changes and fork',
        worktreeForkHeadOnly: 'Fork from HEAD only',
        worktreeForkConfirmClean: 'Create Worktree and fork',
        worktreeForkInspectError: 'Failed to inspect the Git working directory.',
    ...
    sidebar: {
        ...
        needsAttention: ({ count }: { count: number }) => `Wymaga uwagi (${count})`,
    },
    ...
    toolGroup: {
        ...
        read: 'Odczytano',
        searched: 'Wyszukano',
        searchedTimes: ({ count }: { count: number }) => `${plural({ count, one: 'Wyszukano 1 raz', few: `Wyszukano ${count} razy`, many: `Wyszukano ${count} razy` })}`,
        fetched: 'Pobrano',
