...
export const it: TranslationStructure = {
    ...
    status: {
        ...
        online: 'online',
        offline: 'offline',
        running: 'in esecuzione · connesso',
        idle: 'inattivo',
    ...
    settingsFeatures: {
        ...
        showSessionModel: 'Mostra modello della sessione',
        showSessionModelSubtitle: 'Mostra l’icona e il nome del provider IA, oltre al nome e alla versione del modello',
    ...
    sidebar: {
        ...
        needsAttention: ({ count }: { count: number }) => `Richiede attenzione (${count})`,
    },
    ...
    toolGroup: {
        ...
        read: 'Letto',
        searched: 'Ricerca',
        searchedTimes: ({ count }: { count: number }) => count === 1 ? 'Cercato 1 volta' : `Cercato ${count} volte`,
        fetched: 'Recuperato',
        ranTask: 'Task eseguito',
        workedFor: ({ duration }: { duration: string }) => `Worked ${duration}`,
        failedTools: ({ count }: { count: number }) => count === 1 ? '1 strumento non riuscito' : `${count} strumenti non riusciti`,
        hide: 'Nascondi',
    },
    ...
    tools: {
        ...
        outputDisclosure: {
            ...
            openFullTranscript: 'Apri trascrizione completa',
            cancelled: 'Annullato',
            interrupted: 'Interrotto',
            pendingPermission: 'In attesa di autorizzazione',
            exitCode: ({ code }: { code: number }) => `uscita ${code}`,
            lines: ({ count }: { count: number }) => `${count} ${count === 1 ? 'riga' : 'righe'}`,
            truncated: 'troncato',
            omitted: '… output omesso',
        },
        taskView: {
