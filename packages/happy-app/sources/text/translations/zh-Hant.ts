...
export const zhHant: TranslationStructure = {
    ...
    settingsFeatures: {
        ...
        showSessionModelSubtitle: '顯示模型供應商圖示和名稱，以及 AI 模型名稱和型號',
    ...
    session: {
        ...
        worktreeForkAction: '在獨立 Worktree 中分叉…',
        worktreeForkTitle: '在獨立 Worktree 中分叉',
        worktreeForkDirtySubtitle: '選擇新 Worktree 是否繼承目前未提交的修改。',
        worktreeForkCleanSubtitle: '從目前 HEAD 建立獨立工作目錄。',
        worktreeForkBase: '基準',
        worktreeForkStaged: '已暫存修改',
        worktreeForkUnstaged: '未暫存修改',
        worktreeForkUntracked: '未追蹤檔案',
        worktreeForkIgnoredNotice: '忽略檔案不會複製，來源工作目錄不會改變。',
        worktreeForkIncludeChanges: '包含目前修改並分叉',
        worktreeForkHeadOnly: '僅從 HEAD 分叉',
        worktreeForkConfirmClean: '建立 Worktree 並分叉',
        worktreeForkInspectError: '無法檢查 Git 工作目錄。',
    ...
    toolGroup: {
        ...
        read: '已讀取',
        searched: '已搜尋',
        searchedTimes: ({ count }: { count: number }) => `搜尋了 ${count} 次`,
        fetched: '已取得',
        ranTask: '已執行任務',
