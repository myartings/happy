...
import { useFriendRequests, useSocketStatus, useRealtimeStatus, useLocalSettingMutable } from '@/sync/storage';
            ...
            const viewMenuGroups: NativeSettingsMenuGroup[] = [
                {
                    ...
                    selectedKey: flatSessionList ? 'flat' : 'project',
                    onSelect: (key) => setFlatSessionList(key === 'flat'),
                },
