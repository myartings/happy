...
export function getCodexModelModes(): ModelMode[] {
    return [
        ...
        { key: 'gpt-5.6-sol', name: 'GPT-5.6 Sol', description: null, providerId: 'openai', providerName: 'OpenAI', serviceTiers: ['fast'] },
        { key: 'gpt-5.6-terra', name: 'GPT-5.6 Terra', description: null, providerId: 'openai', providerName: 'OpenAI', serviceTiers: ['fast'] },
        { key: 'gpt-5.6-luna', name: 'GPT-5.6 Luna', description: null, providerId: 'openai', providerName: 'OpenAI', serviceTiers: ['fast'] },
    ];
}
