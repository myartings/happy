...
vi.mock('@/features/studio-tool-presentation/useStudioToolPresentation', () => ({ useStudioToolPresentation: () => null }));
vi.mock('@/features/studio-execution-transcript/studioExecutionTranscript', () => ({ resolveStudioExecutionTranscript: () => null }));
vi.mock('@/features/studio-execution-transcript/StudioExecutionTranscriptView', () => ({ StudioExecutionTranscriptView: () => null }));
vi.mock('@/features/studio-tool-output-disclosure/StudioToolOutputActions', () => ({ StudioToolOutputActions: () => null }));
vi.mock('@/features/studio-tool-output-disclosure/StudioToolFullTranscriptView', () => ({ StudioToolFullTranscriptView: () => null }));
